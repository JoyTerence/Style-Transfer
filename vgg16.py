...
path_graph_def = r"C:\Users\Joy.DESKTOP-M53NCFS\Documents\GitHub\Style-Transfer\vgg_16\vgg16.tfmodel"
...
class VGG16:
    ...
    def get_style_layer_tensors(self):
        """
        Return a list of references to the tensors for the layers with the given id's.
        """

        return [self.layer_tensors[1], self.layer_tensors[3], self.layer_tensors[6], self.layer_tensors[9], self.layer_tensors[12]]

    def get_content_layer_tensors(self):
        """
        Return a list of names for the layers with the given id's.
        """

        return self.layer_tensors[3]
